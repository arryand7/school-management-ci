...
class Start extends CI_Controller {
    ...
    private function write_db_config() {
        ...
        $new_database_file_lines = array(
            "<?php defined('BASEPATH') or exit('No direct script access allowed');",
            '',
            '$query_builder = true;',
            '',
            "\$db['default'] = " . var_export($default_db_settings, true) . ';',
            '',
        ...
        $new_database_file = implode(PHP_EOL, $new_database_file_lines);
        ...
        $bytes_written = fwrite($fp, $new_database_file);
        fclose($fp);
