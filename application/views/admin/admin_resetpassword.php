                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12 nopadding">  
                                <div class="loginbg">  
                                    ...
                                    <div class="form-bottom">
                                        ...
                                        <a href="<?php echo site_url('site/auth') ?>" class="forgot"><i class="fa fa-key"></i> <?php echo $this->lang->line('admin_login'); ?></a>
                                    </div>
                                </div>
                              
                        </div>
                        <div class="col-lg-8 col-md-8 col-sm-12 nopadding-2">
                                 <div class="d-flex align-items-center text-wrap flex-column justify-content-center bg-position-sm-left bg-position-lg-center" style="background: url('<?php echo base_url(); ?>uploads/school_content/login_image/<?php echo $admin_login_page_background; ?>') no-repeat; background-size:cover"> 
...
if ($notice) {
    ?>
                                    ...
                                    <h3 class="h3"><?php echo $this->lang->line('whats_new_in'); ?> <?php echo $name; ?></h3>
