                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12 nopadding <?php echo $bgoffsetbgno; ?> <?php echo $offset; ?>">
                                <div class="loginbg">
                                    ...
                                    <div class="form-bottom">
                                        ...
                                        ?>
                                        <form action="<?php echo site_url('site/auth') ?>" method="post">
                                        ...
                                        <a href="<?php echo site_url('site/forgotpassword') ?>" class="forgot"><i class="fa fa-key"></i> <?php echo $this->lang->line('forgot_password'); ?> (<?php echo $this->lang->line('admin_login'); ?>)</a>
                                        <a href="<?php echo site_url('site/ufpassword') ?>" class="forgot"><i class="fa fa-key"></i> <?php echo $this->lang->line('forgot_password'); ?> (<?php echo $this->lang->line('user_login'); ?>)</a>
                                    </div>
                                </div>
                            </div>
